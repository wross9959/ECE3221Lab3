...
a0:
    addi r22, r22, 1        # go to the next digit 
    ori r4, r0, 0x02        # Select digit 1
    and r3, r4, r5          # check if enabled
    beq r3, r0, a1          # if (! enabled) skip
    call incx           

a1:
	addi r22, r22, 1        # go to the next digit 
    ori r4, r0, 0x04        # Select digit 2
    and r3, r4, r5          # check if enabled
    beq r3, r0, a2          # if (! enabled) skip
    call incx 

a2:
    addi r22, r22, 1        # go to the next digit 
    ori r4, r0, 0x08        # Select digit 1
    and r3, r4, r5          # check if enabled
    beq r3, r0, a3          # if (! enabled) skip
    call incx 
...
init:
	...
	movia r4, b00001111		# HEX display's to turn on HEX3-HEX0
...
switch0:
	...
	switch_down:
		...
		bne r4, r0, down		# if(r4 == 0) wait till switch goes up
